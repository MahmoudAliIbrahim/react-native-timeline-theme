...
export default class Timeline extends Component {
      ...
      case 'single-column-right':
        content = (
          <View style={[styles.rowContainer,columnFormat === 'single-column-left' ? {} : {flexDirection: 'row-reverse', justifyContent: 'flex-start' }, rowContainerStyle]}>
            <View>
              {this.props.showTime && this.renderTime(item, index)}
            </View>
            <View>
  ...
  renderDetail = (item, index) => {
    ...
    if (renderDetail) return renderDetail({ itemData: item, titleStyle: [styles.title, titleStyle], descriptionStyle, renderDetail }, index)
    return (
